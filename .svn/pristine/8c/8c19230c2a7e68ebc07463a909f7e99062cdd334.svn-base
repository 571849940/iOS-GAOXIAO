...
@interface DrawerViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
    ...
    PersonInformationViewController *personCon;
}
...
@property (strong, nonatomic) IBOutlet UILabel *showPersonName;
...
- (void)viewDidLoad {
    ...
    personCon = [[PersonInformationViewController alloc]init];
    
    [personCon sendPerson:^(NSString *nameBlock) {
        
        _showPersonName.text = nameBlock;
    }];
