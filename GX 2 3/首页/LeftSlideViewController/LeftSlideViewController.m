...
{
    [UIView beginAnimations:nil context:nil];
//    self.mainVC.view.transform = CGAffineTransformScale(CGAffineTransformIdentity,kMainPageScale,kMainPageScale);  //缩放效果
    self.mainVC.view.transform = CGAffineTransformTranslate(CGAffineTransformIdentity, kLeftCenterX, 0);  //平移效果
